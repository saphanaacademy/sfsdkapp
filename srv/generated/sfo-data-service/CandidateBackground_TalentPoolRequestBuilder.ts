 ...
 */
export class CandidateBackground_TalentPoolRequestBuilder extends RequestBuilder<CandidateBackground_TalentPool> {
  /**
  ...
  getByKey(backgroundElementId: BigNumber): GetByKeyRequestBuilder<CandidateBackground_TalentPool> {
    return new GetByKeyRequestBuilder(CandidateBackground_TalentPool, { backgroundElementId: backgroundElementId });
  }
  ...
  getAll(): GetAllRequestBuilder<CandidateBackground_TalentPool> {
    return new GetAllRequestBuilder(CandidateBackground_TalentPool);
  }
  ...
  create(entity: CandidateBackground_TalentPool): CreateRequestBuilder<CandidateBackground_TalentPool> {
    return new CreateRequestBuilder(CandidateBackground_TalentPool, entity);
  }
  ...
  update(entity: CandidateBackground_TalentPool): UpdateRequestBuilder<CandidateBackground_TalentPool> {
    return new UpdateRequestBuilder(CandidateBackground_TalentPool, entity);
  }
}
